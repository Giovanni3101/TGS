      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 m-auto">
        ...
        <div className="text-center mb-16">
          ...
          <Paragraph
            ...
            style={{ fontFamily: "'Raleway', sans-serif" }}
          >
            At The Growth Sphere, we believe that talent knows no borders, but
            access to opportunity does. From villages to cities, from the Global
            South to the North, every young person deserves an equal and fair
            chance to rise.
          </Paragraph>
        </div>
